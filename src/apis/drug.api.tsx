...
const drugApi = {
	getList: async (params: any): Promise<IPageResponse<IDrugResponse[]>> => {
		try {
			const response = await privateClient.post<IPageResponse<IDrugResponse[]>>(
				endPoint.getList,
	...
	getListInv: async (params: any): Promise<IPageResponse<IDrugResponse[]>> => {
		try {
			const response = await privateClient.get<IPageResponse<IDrugResponse[]>>(
